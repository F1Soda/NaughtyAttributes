...
namespace NaughtyAttributes.Editor
{
    ...
    public static class ValidatorAttributeExtensions
    {
        ...
        static ValidatorAttributeExtensions()
        {
            ...
            _validatorsByAttributeType[typeof(AutoAssignByFilterAttribute)] = new AutoAssignByFilterPropertyValidator();
            _validatorsByAttributeType[typeof(AutoAssignByGuidAttribute)] = new AutoAssignByGuidPropertyValidator();
        }
